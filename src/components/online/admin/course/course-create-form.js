                    ...
                    >
                        ...
                        >
                            <TextField
                                ...
                                label="Modules count"
                                name="modules_count"
                                value={formik.values.modules_count}
                                onChange={formik.handleChange}
                                onBlur={formik.handleBlur}
                                error={Boolean(formik.touched.modules_count && formik.errors.modules_count)}
                                helperText={formik.touched.modules_count && formik.errors.modules_count}
                            />
                            <TextField
                                fullWidth
                                color="secondary"
                                ...
                                onChange={formik.handleChange}
                                onBlur={formik.handleBlur}
                                error={Boolean(formik.touched.lessons_count && formik.errors.lessons_count)}
                                helperText={formik.touched.lessons_count && formik.errors.lessons_count}
                            />
                            <TextField
                                fullWidth
                                color="secondary"
